...
KERNEL_DIR=$PWD
KERNEL="Image.gz-dtb"
KERN_IMG=$KERNEL_DIR/out/arch/arm64/boot/Image.lz4
BASE_VER="Putangnized"
VER="-v0-$(date +"%Y-%m-%d"-%H%M)-"
BUILD_START=$(date +"%s")
ANYKERNEL_DIR=/home/android/Downloads/Putang2xl/
ANYKERNEL_DIR_KERNEL=/home/android/Downloads/Putang2xl/kernel
EXPORT_DIR=/home/android/Desktop/zips/

# Change every build
ZIP_NAME="Putangnized-taimen-0.1"
...
export KBUILD_BUILD_USER="Pixelnized"
...
echo -e "***********************************************$nocol"
   ...
   cp -vr ${KERN_IMG} ${ANYKERNEL_DIR_KERNEL} 
   cd ${ANYKERNEL_DIR}
